...
const projects = [
  {
    ...
    type: "Local Business · Tattoo Shop Website",
    description: [
    ...
    outcome: "A professional online presence that matches the quality of the work — and converts local search visitors into clients.",
    tags: ["Next.js", "Mobile-First", "Local SEO", "Booking Integration", "Photography Layout"],
  },
  {
    num: "02",
    name: "Rustic Mountain Dental",
    type: "Healthcare · Website + AI Receptionist",
    description: [
  ...
  },
  {
    ...
    type: "B2B · Industrial Services Website",
    description: [
  ...
  },
  {
    ...
    type: "Membership Platform · Stripe + Auth",
    description: [
    ...
    outcome: "A fully automated membership platform. No manual intervention needed to onboard, manage, or offboard subscribers.",
    tags: ["Next.js", "Stripe", "Supabase", "Auth.js", "Webhooks", "Gated Content", "Row-Level Security"],
  },
  {
    num: "05",
    name: "The Tire Chair",
    type: "E-commerce · Conversion Optimization",
    description: [
      ...
      "Analyzed where users were losing interest and made targeted changes to the product page structure, social proof placement, and checkout flow. Worked hands-on with both the technical side and the advertising strategy to ensure the changes translated to results.",
    ],
